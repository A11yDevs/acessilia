...
|---|---|---|---|
| [0001](0001-premature-done-history-mismatch.md) | Sucesso antes dos artefatos e histórico divergente | 🟠 Alta | Aberto · reproduzido em ambiente isolado |
| [0002](0002-queued-cancellation-ignored.md) | Job cancelado na fila é executado | 🟠 Alta | Aberto · reproduzido em ambiente isolado |
| [0003](0003-export-cancellation-ignored.md) | Cancelamento durante exportação permite publicação do resultado | 🟠 Alta | Aberto · reproduzido em ambiente isolado |
...
| [0009](0009-thinking-mode-no-effect.md) | Thinking mode é uma opção sem efeito no legacy | 🟡 Média | Corrigido localmente · aguardando integração |
...
| [0011](0011-tts-failure-silent-success.md) | Falha de áudio fica invisível no resultado público | 🟠 Alta | Aberto · reproduzido em ambiente isolado |
| [0012](0012-early-failure-stuck-queued.md) | Falha inicial deixa tarefa eternamente na fila | 🟠 Alta | Aberto · reproduzido em ambiente isolado |
| [0013](0013-web-download-wrong-origin.md) | Página web gera links para a porta errada | 🟠 Alta | Aberto · reproduzido em ambiente isolado |
| [0014](0014-output-retention-too-short.md) | Retenção real é de 24 horas, promessa é de sete dias | 🟠 Alta | Aberto · reproduzido em ambiente isolado |
| [0015](0015-expired-token-still-valid.md) | Expiração não é validada na consulta do token | 🟡 Média | Aberto · reproduzido em ambiente isolado |
| [0016](0016-web-upload-missing-size-limit.md) | Limite de upload aplicado somente depois de gravar no frontend | 🟡 Média | Aberto · reproduzido em ambiente isolado |
| [0017](0017-compose-builds-test-stage.md) | Compose local constrói o estágio test | 🟠 Alta | Aberto · confirmado por configuração |
| [0018](0018-staging-ignores-dotenv-branch.md) | Staging ignora branch do .env se token já estiver no ambiente | 🟠 Alta | Aberto · reproduzido em ambiente isolado |
| [0019](0019-staging-fallback-unreachable.md) | Fallback de atualização não cobre falha HTTP ou rede | 🟡 Média | Aberto · reproduzido em ambiente isolado |
| [0020](0020-delivery-not-gated-by-ci.md) | Publicação não aguarda os testes de CI | 🟠 Alta | Aberto · confirmado por configuração |
