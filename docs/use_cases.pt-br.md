...
- Implementação:
  ...
  - processamento: [backend/service.py](../backend/service.py) seleciona o motor (`PIPELINE_ENGINE`): o workflow Agno [backend/agents/workflow.py](../backend/agents/workflow.py) ou o orquestrador PDDL [backend/agents/pddl_orchestrator.py](../backend/agents/pddl_orchestrator.py); ambos alimentam o [backend/pipeline/canonical_builder.py](../backend/pipeline/canonical_builder.py)
...
- Implementação:
  ...
  - uso no fluxo: [backend/service.py](../backend/service.py) e [backend/agents/workflow.py](../backend/agents/workflow.py)
