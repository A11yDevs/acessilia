"""Export profiles and verbosity mapping.

Ported from backend/pipeline/verbosity_manager.py. Pure: no settings
access — the consumer chooses which profile to apply.
"""
