"""Pandoc AST builder for canonical documents.

Ported from backend/pipeline/pandoc_ast_builder.py. Pure: deterministic
document dict -> Pandoc JSON AST (in-memory dict), no I/O.
"""
